...
y_score = []
test_loss = 0
criterion = torch.nn.CrossEntropyLoss()  # Assuming you are using CrossEntropyLoss
...
train_metrics = pd.read_csv('train_metrics.csv')  # Assuming you saved training metrics in a CSV file
